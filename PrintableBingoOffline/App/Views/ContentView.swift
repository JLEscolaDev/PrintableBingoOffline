...
//            let columnsCount = Int(sqrt(Double(allNumbers.count)).rounded(.up))
//            
//            // Calcula el tamaño de las celdas considerando el espaciado
//            let totalSpacing = spacing * CGFloat(columnsCount - 1)
//            let cellWidth = (geometry.size.width - totalSpacing) / CGFloat(columnsCount)
//            let rowsCount = Int(ceil(Double(allNumbers.count) / Double(columnsCount)))
//            let totalVerticalSpacing = spacing * CGFloat(rowsCount - 1)
//            let cellHeight = (geometry.size.height - totalVerticalSpacing) / CGFloat(rowsCount)
//            
...
//                        .cornerRadius(cellWidth * 0.1) // Esquinas redondeadas basadas en el tamaño de la celda
//                        .foregroundColor(.white) // Texto blanco
//                        .font(.system(size: min(cellWidth, cellHeight) * 0.4)) // Tamaño de fuente dinámico
//                        .bold()
//                }
//            }
//            .padding(spacing) // Padding alrededor del grid
//        }
//    }
//}
//
...
//    
//    @Published private(set) var musicVolume: Float = 1.0 {
//        didSet {
//            audioPlayerMusic?.volume = musicVolume
//        }
//    }
//    
//    @Published private(set) var voiceVolume: Float = 1.0 {
//        didSet {
//            audioPlayerVoice?.volume = voiceVolume
//        }
//    }
//    
//    func playMusic(songName: String, numberOfLoops: Int = 0) {
...
//            audioPlayerMusic?.delegate = self
//            audioPlayerMusic?.numberOfLoops = numberOfLoops
//            audioPlayerMusic?.volume = musicVolume
...
//        audioPlayerMusic = nil
//    }
//    
//    func fadeOutMusic(duration: TimeInterval = 2.0, completion: (() -> Void)? = nil) {
//        guard let player = audioPlayerMusic, player.isPlaying else { return }
//        let steps = 20
//        let stepTime = duration / Double(steps)
//        let volumeDecrement = musicVolume / Float(steps)
//        var currentStep = 0
//        
//        Timer.scheduledTimer(withTimeInterval: stepTime, repeats: true) { [weak self] timer in
//            guard let self = self else {
//                timer.invalidate()
//                return
//            }
//            if currentStep < steps {
//                self.setMusicVolume(self.musicVolume - volumeDecrement)
//                currentStep += 1
//            } else {
//                player.stop()
//                timer.invalidate()
...
//    }
//    
//    func playVoiceAudio(from url: URL, completion: (() -> Void)? = nil) {
//        do {
...
//}
//
//// MARK: - BINGO VIEW MODEL
//@MainActor
//class BingoViewModel: NSObject, ObservableObject {
...
//    
//    private let normalCalls: [Int: [String]] = [
//        1: ["El galán", "El pequeño"], 2: ["El patito", "El sol"], 3: ["San Cono, el Santo de la suerte"],
//        4: ["La cama"], 5: ["El galo", "La espina"], 6: ["El perro", "El corazón"],
//        7: ["El revólver", "La pipa", "La muleta"], 8: ["El incendio", "La dama", "La señora gorda"],
//        9: ["El zapato", "El arroyo"], 10: ["La rosa", "El cañón"], 11: ["Las banderillas", "El minero", "Los soldaditos"],
//        12: ["El soldado"], 13: ["La mala pata", "El número de la mala suerte"], 14: ["El borracho", "La cerveza"],
//        15: ["La niña bonita"], 16: ["El anillo", "La guitarra"], 17: ["La desgracia", "El barco de vela"],
//        18: ["La sangre", "Los ojos", "El ramillete"], 19: ["San José", "El Correo para Cuba"], 20: ["La fiesta", "El tío del queso"],
//        21: ["La mujer", "La primavera"], 22: ["Los dos patitos"], 23: ["El cocinero", "El melón"],
//        24: ["El caballo", "Nochebuena"], 25: ["Navidad"], 26: ["La misa", "Los pollos"],
//        27: ["El peine", "La pajarita", "La pajarera"], 28: ["El cerro", "Alicante"], 29: ["San Pedro", "El viaje"],
//        30: ["Santa Rosa", "El león"], 31: ["La luz", "Los caballos"], 32: ["El dinero"], 33: ["La edad de Cristo"],
//        34: ["La cabeza", "El garrote"], 35: ["El pajarito", "El fuego"], 36: ["La castaña", "La sangre"],
//        37: ["Los eucaliptos", "La espada"], 38: ["Las piedras", "El perro"], 39: ["La lluvia", "El toro"],
//        40: ["El cura"], 41: ["El cuchillo"], 42: ["Las zapatillas"], 43: ["El balcón", "La corona"],
//        44: ["La cárcel", "Los tacones"], 45: ["El vino"], 46: ["Los tomates", "El sombrero"], 47: ["El muerto"],
//        48: ["El borrego", "La negra", "El muerto que habla"], 49: ["La carne"], 50: ["El pan"],
//        51: ["El serrucho"], 52: ["La madre y el hijo"], 53: ["El barco"], 54: ["La vaca"],
//        55: ["Los civiles (Guardia Civil)"], 56: ["La caída"], 57: ["El jorobado"], 58: ["El ahogado"],
//        59: ["Las plantas"], 60: ["La virgen"], 61: ["La escopeta"], 62: ["La inundación"],
//        63: ["El casamiento"], 64: ["El llanto"], 65: ["El cazador"], 66: ["La lombriz"],
//        67: ["La mordida"], 68: ["Los sobrinos"], 69: ["Los vicios"], 70: ["Los muertos", "El sueño"],
//        71: ["El maestro", "El excremento"], 72: ["La sorpresa"], 73: ["El hospital"], 74: ["La escalera"],
//        75: ["Los besos"], 76: ["Las llamas"], 77: ["Las dos banderas"], 78: ["La ramera"],
//        79: ["El ladrón"], 80: ["La bocha"], 81: ["Las flores"], 82: ["La pelea", "El jarro"],
//        83: ["El mal tiempo"], 84: ["La iglesia"], 85: ["La linterna"], 86: ["El humo"],
//        87: ["Los piojos"], 88: ["Las calabazas", "Las gordas"], 89: ["La rata", "La gamba"],
//        90: ["El abuelo (fin del juego)"]
//    ]
//    
//    private let normalCallsEnglish: [Int: [String]] = [
//        1: ["Kelly's Eye"], 2: ["One Little Duck"], 3: ["Goodness Me"], 4: ["Knock at the Door"],
//        5: ["One Little Snake"], 6: ["Tom Mix"], 7: ["Lucky Seven"], 8: ["Garden Gate"], 9: ["Doctor's Orders"],
//        10: ["Blind 10"], 11: ["Legs Eleven"], 12: ["A Monkey's Cousin"], 13: ["Unlucky for Some"],
//        14: ["Valentine's Day"], 15: ["Young and Keen"], 16: ["Sweet Sixteen"], 17: ["Old Ireland"],
//        18: ["Coming of Age"], 19: ["Goodbye-Teens"], 20: ["Blind 20, One Score"], 21: ["Key to the Door"],
//        22: ["Two Little Ducks"], 23: ["Thee and Me"], 24: ["Two Dozen"], 25: ["Duck and Dive"],
//        26: ["Pick 'n Mix"], 27: ["Gateway to Heaven"], 28: ["Overweight"], 29: ["Rise and Shine"],
//        30: ["Blind 30, Dirty Gertie"], 31: ["Get up and Run"], 32: ["Buckle my Shoe"], 33: ["Blind Thirty, Three Feathers, Gertie Lee, Dirty Knee"],
//        34: ["Ask for More"], 35: ["Jump and Jive"], 36: ["Three Dozen"], 37: ["More than Eleven"],
//        38: ["Christmas Cake"], 39: ["Steps"], 40: ["Blind Forty, Naughty Forty, Life Begins"], 41: ["Time for Fun, Life’s Begun"],
//        42: ["Winnie the Pooh"], 43: ["Down on your Knee"], 44: ["All the Fours, Droopy Drawers"], 45: ["Halfway There"],
//        46: ["Up to Tricks"], 47: ["Four and Seven"], 48: ["Four Dozen"], 49: ["Rise and Shine"],
//        50: ["Blind 50, It's a Bullseye, Half a Century"], 51: ["Tweak of the Thumb"], 52: ["Weeks of the Year"],
//        53: ["Stuck in the Tree"], 54: ["Clean the Floor"], 55: ["Snakes Alive"], 56: ["Shotts Bus"],
//        57: ["Heinz Varieties"], 58: ["Make Them Wait"], 59: ["Brighton Line"], 60: ["Blind 60, Five Dozen"],
//        61: ["Bakers Bun"], 62: ["Turn of the Screw"], 63: ["Tickle Me"], 64: ["Red Raw"], 65: ["Old Age Pension"],
//        66: ["Clickety Click"], 67: ["Made in Heaven"], 68: ["Pick a Mate, Saving Grace"], 69: ["Either Way Up, Meal for Two"],
//        70: ["Blind 70, Three Score & Ten"], 71: ["Bang on the Drum"], 72: ["Six Dozen, Par for the Course"],
//        73: ["Queen Bee"], 74: ["Candy Store"], 75: ["Strive & Strive"], 76: ["Trombones"], 77: ["All the Sevens, Two Little Crutches"],
//        78: ["Heavens Gate"], 79: ["One More Time"], 80: ["Blind 80, Ate Nothing, Gandhi's Breakfast"], 81: ["Stop & Run"],
//        82: ["Straight On Through"], 83: ["Time for Tea, Ethel’s Ear"], 84: ["Seven Dozen"], 85: ["Staying Alive"],
//        86: ["Between the Sticks"], 87: ["Torquay in Devon"], 88: ["All the Eights, Two Fat Ladies"], 89: ["Nearly There"],
//        90: ["Top of the Shop"]
//    ]
//    
//    private let guarrosCalls: [Int: [String]] = [
//        0: ["Te reviento el agujero."], 1: ["Con mi pene te vacuno."], 2: ["Te la meto como un dios."],
//        3: ["Te la meto del revés."], 4: ["Por tu culo mi aparato."], 5: ["Por el culo te la hinco."],
//        6: ["Si os agachais me la veis."], 7: ["Te la meto en el retrete."], 8: ["Por el culo te la embrocho."],
//        9: ["En el culo se me mueve."], 10: ["Chupamela otra vez."], 11: ["La tengo de bronce."],
//        12: ["Te la meto sin que roce."], 13: ["En tu culo se me cuece."], 14: ["Cuidado no la forces."],
//        15: ["No me la hagas un esguince."], 16: ["Me la cogeis la moveis."], 17: ["Por la boca te la mete."],
//        18: ["Por el culo te la entocho."], 19: ["Ya tiene duro el pene."], 20: ["Mi pene ya en tu mente."],
//        21: ["La chupa como ninguno."], 22: ["Te la meto sin adiós."], 23: ["Te la coloco del revés."],
//        24: ["Con dos huevos y mi aparato te dibujo tu retrato."], 25: ["Por el culo te la hinco."],
//        26: ["Si os arrodilláis me la veis."], 27: ["Toca el saca y mete."], 28: ["Te caliento el bizcocho."],
//        29: ["Chupadita mientras bebe."], 30: ["Se la meto a la parienta."], 31: ["Te la comes como ninguno."],
//        32: ["Te la meto y dices adiós."], 33: ["Te la comes con interés."], 34: ["Te la pongo en un rato."],
//        35: ["Y vamos a por el bingo."], 36: ["Esta os la coméis."], 37: ["Yegua mía, te presento al jinete."],
//        38: ["Te presento al pelocho"], 39: ["Con suerte se te mueve."], 40: ["Te la meto sin tormenta."],
//        41: ["Con esta te rompo el ayuno."], 42: ["Te dejo sin voz."], 43: ["Te cojo con fluidez."],
//        44: ["A aplaudir al cuarto."], 45: ["Por el culo te la hinco."], 46: ["A esta edad ya ni lo intentéis."],
//        47: ["Entro con fuerza como si fuera un ariete."], 48: ["Dura como palo de mocho"], 49: ["Una tocadita leve"],
//        50: ["Me la meto contenta."], 51: ["Te la comes de desayuno."], 52: ["Me la soplas como el lobo feroz"],
//        53: ["Te la ajusto otra vez."], 54: ["Te la meto de inmediato."], 55: ["Por delante y por detrás para hacerlo distinto"],
//        56: ["Si no os gusta no miréis"], 57: ["Polvete en el retrete."], 58: ["Me crece como a pinocho"],
//        59: ["En el culo se te mueve"], 60: ["Te la meto en la grieta."], 61: ["La tengo gorda como luchador de sumo."],
//        62: ["Las comes de dos en dos"], 63: ["Te la sirvo con estrés."], 64: ["Te ensarto de inmediato."],
//        65: ["Tarariro tarariro"], 66: ["Si os agacháis me la veis."], 67: ["Te la meto en el retrete."],
//        68: ["A una de comer chocho"], 69: ["Por el culo te la hinco, la postura más perversa."],
//        70: ["Te la meto sin afrenta."], 71: ["Te la tragas con zumo."], 72: ["Te la meto veloz."],
//        73: ["Te la ajusto con fluidez."], 74: ["Te la meto sin trato."], 75: ["Por el culo te la hinco, sin descanso a los setenta y cinco."],
//        76: ["Si te agachas me la veis."], 77: ["Te la meto en el retrete."], 78: ["Te la entocho con un poncho."],
//        79: ["Te la chupo si llueve."], 80: ["Te la meto sin tormenta."], 81: ["Te la hundo sin ninguno."],
//        82: ["Te la sirvo a dos en dos."], 83: ["Te la pongo al revés."], 84: ["Te la meto sin teatro."],
//        85: ["Por el culo te la hinco, más profundo a los ochenta y cinco."], 86: ["Si te agachas me la veis."],
//        87: ["Te la meto en el retrete."], 88: ["Te la entocho con un corcho."], 89: ["Te penetro si llueve."],
//        90: ["Te la meto con la cuenta."]
//    ]
//    
//    private let genericPhrases = [
...
//    func stopDrawing() {
//        isDrawing = false
//        audioPlayerManager.stopVoiceAudio()
//    }
//    
//    private func scheduleNextDraw() {
//        DispatchQueue.main.asyncAfter(deadline: .now() + drawInterval) {
...
//        let commentFileName = "\(number)-\(language)-\(mode)"
//        
//        if let numberURL = Bundle.main.url(forResource: numberFileName, withExtension: "mp3", subdirectory: numbersSubdirectory) {
//            audioPlayerManager.playVoiceAudio(from: numberURL) {
//                if let commentURL = Bundle.main.url(forResource: commentFileName, withExtension: "mp3", subdirectory: commentsSubdirectory) {
//                    self.audioPlayerManager.playVoiceAudio(from: commentURL) {
//                        self.scheduleNextDraw()
//                    }
//                } else {
//                    self.scheduleNextDraw()
...
//            }
//        } else {
//            let genericFileName = "generic-\(language)"
//            if let genericURL = Bundle.main.url(forResource: genericFileName, withExtension: "mp3", subdirectory: numbersSubdirectory) {
//                audioPlayerManager.playVoiceAudio(from: genericURL) {
//                    self.scheduleNextDraw()
//                }
//            } else {
//                scheduleNextDraw()
...
//        audioPlayerManager.playMusic(songName: "YourMusicFile", numberOfLoops: -1)
//    }
//    
//    func fadeOutBackgroundMusic(duration: TimeInterval = 3.0) {
//        audioPlayerManager.fadeOutMusic(duration: duration)
//    }
//    
...
//        let points = (0..<5).map { i -> CGPoint in
//            let angle = (Double(i) * 72.0 - 90.0) * Double.pi / 180.0
//            return CGPoint(x: c.x + CGFloat(cos(angle)) * radius,
...
//    var body: some View {
//        GeometryReader { geometry in
//            let columnsCount = max(3, Int(geometry.size.width / 60))
...
//}
//
//// MARK: - UNEVEN ROUNDED RECTANGLE (SIMPLE SHAPE)
//
//struct UnevenRoundedRectangle: Shape {
//    var cornerRadii: CornerRadii
//    
//    func path(in rect: CGRect) -> Path {
//        let topLeftRadius = cornerRadii.topLeading
//        let topRightRadius = cornerRadii.topTrailing
//        let bottomLeftRadius = cornerRadii.bottomLeading
//        let bottomRightRadius = cornerRadii.bottomTrailing
//        
//        var path = Path()
...
//            VStack(alignment: .leading) {
//                ZStack {
//                    UnevenRoundedRectangle(cornerRadii: .init(topLeading: 20, topTrailing: 20, bottomLeading: 20, bottomTrailing: 20))
//                        .fill(.black.opacity(0.8))
//                        .frame(width: 200, height: 100)
//                    
//                    VStack {
